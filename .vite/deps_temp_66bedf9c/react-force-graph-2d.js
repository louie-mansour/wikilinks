...
function _iterableToArrayLimit2(r2, l2) {
  ...
  if (null != t5) {
    ...
    try {
      ...
      else for (; !(f2 = (e3 = i2.call(t5)).done) && (a2.push(e3.value), a2.length !== l2); f2 = true) ;
    } catch (r3) {
      o2 = true, n2 = r3;
    } finally {
      try {
...
function _unsupportedIterableToArray2(r2, a2) {
  if (r2) {
    ...
    return "Object" === t5 && r2.constructor && (t5 = r2.constructor.name), "Map" === t5 || "Set" === t5 ? Array.from(r2) : "Arguments" === t5 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t5) ? _arrayLikeToArray2(r2, a2) : void 0;
  }
}
...
function data_default(value, key) {
  ...
  for (var m2 = groups2.length, update5 = new Array(m2), enter = new Array(m2), exit = new Array(m2), j2 = 0; j2 < m2; ++j2) {
...
function drag_default() {
  ...
  function touchstarted(event, d2) {
    ...
    var touches = event.changedTouches, c4 = container.call(this, event, d2), n2 = touches.length, i2, gesture;
    for (i2 = 0; i2 < n2; ++i2) {
      if (gesture = beforestart(this, c4, event, d2, touches[i2].identifier, touches[i2])) {
        nopropagation(event);
...
function exponential(a2, b10, y2) {
  return a2 = Math.pow(a2, y2), b10 = Math.pow(b10, y2) - a2, y2 = 1 / y2, function(t5) {
    return Math.pow(a2 + t5 * b10, y2);
  };
}
function hue(a2, b10) {
  var d2 = b10 - a2;
...
function number_default(a2, b10) {
  return a2 = +a2, b10 = +b10, function(t5) {
    return a2 * (1 - t5) + b10 * t5;
  };
}
...
function decompose_default(a2, b10, c4, d2, e3, f2) {
  var scaleX, scaleY, skewX;
  if (scaleX = Math.sqrt(a2 * a2 + b10 * b10)) a2 /= scaleX, b10 /= scaleX;
  if (skewX = a2 * c4 + b10 * d2) c4 -= a2 * skewX, d2 -= b10 * skewX;
  if (scaleY = Math.sqrt(c4 * c4 + d2 * d2)) c4 /= scaleY, d2 /= scaleY, skewX /= scaleY;
  if (a2 * d2 < b10 * c4) a2 = -a2, b10 = -b10, skewX = -skewX, scaleX = -scaleX;
  return {
    translateX: e3,
    translateY: f2,
...
function hcl2(hue2) {
  return function(start2, end) {
    var h2 = hue2((start2 = hcl(start2)).h, (end = hcl(end)).h), c4 = nogamma(start2.c, end.c), l2 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t5) {
      start2.h = h2(t5);
      start2.c = c4(t5);
      start2.l = l2(t5);
...
function interpolate_default(a2, b10) {
  var c4;
  return (typeof b10 === "number" ? number_default : b10 instanceof color ? rgb_default : (c4 = color(b10)) ? (b10 = c4, rgb_default) : string_default)(a2, b10);
}
...
var elasticIn = function custom7(a2, p2) {
  ...
  function elasticIn2(t5) {
    return a2 * tpmt(- --t5) * Math.sin((s2 - t5) / p2);
  }
...
var elasticOut = function custom8(a2, p2) {
  ...
  function elasticOut2(t5) {
    return 1 - a2 * tpmt(t5 = +t5) * Math.sin((t5 + s2) / p2);
  }
...
var elasticInOut = function custom9(a2, p2) {
  ...
  function elasticInOut2(t5) {
    return ((t5 = t5 * 2 - 1) < 0 ? a2 * tpmt(-t5) * Math.sin((s2 - t5) / p2) : 2 - a2 * tpmt(t5) * Math.sin((s2 + t5) / p2)) / 2;
  }
...
function zoom_default2() {
  ...
  function schedule(transition2, transform3, point2, event) {
    transition2.on("start.zoom", function() {
      ...
      var that = this, args = arguments, g2 = gesture(that, args).event(event), e3 = extent2.apply(that, args), p2 = point2 == null ? centroid(e3) : typeof point2 === "function" ? point2.apply(that, args) : point2, w2 = Math.max(e3[1][0] - e3[0][0], e3[1][1] - e3[0][1]), a2 = that.__zoom, b10 = typeof transform3 === "function" ? transform3.apply(that, args) : transform3, i2 = interpolate(a2.invert(p2).concat(w2 / a2.k), b10.invert(p2).concat(w2 / b10.k));
      return function(t5) {
        if (t5 === 1) t5 = b10;
        else {
...
function bisector(f2) {
  ...
  if (f2.length !== 2) {
    compare1 = ascending2;
    compare2 = (d2, x2) => ascending2(f2(d2), x2);
...
function blurh(blur3, T2, S2, w2, h2) {
  for (let y2 = 0, n2 = w2 * h2; y2 < n2; ) {
    blur3(T2, S2, y2, y2 += w2, 1);
  }
}
function blurv(blur3, T2, S2, w2, h2) {
  for (let x2 = 0, n2 = w2 * h2; x2 < w2; ++x2) {
    blur3(T2, S2, x2, x2 + n2, w2);
  }
}
...
function shuffler(random2) {
  return function shuffle2(array3, i0 = 0, i1 = array3.length) {
    let m2 = i1 - (i0 = +i0);
    while (m2) {
      const i2 = random2() * m2-- | 0, t5 = array3[m2 + i0];
...
function _unsupportedIterableToArray3(r2, a2) {
  if (r2) {
    ...
    var t5 = {}.toString.call(r2).slice(8, -1);
    return "Object" === t5 && r2.constructor && (t5 = r2.constructor.name), "Map" === t5 || "Set" === t5 ? Array.from(r2) : "Arguments" === t5 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t5) ? _arrayLikeToArray3(r2, a2) : void 0;
  }
}
...
function rgbaToHex(r2, g2, b10, a2, allow4Char) {
  var hex2 = [pad2(Math.round(r2).toString(16)), pad2(Math.round(g2).toString(16)), pad2(Math.round(b10).toString(16)), pad2(convertDecimalToHex(a2))];
...
function rgbaToArgbHex(r2, g2, b10, a2) {
  var hex2 = [pad2(convertDecimalToHex(a2)), pad2(Math.round(r2).toString(16)), pad2(Math.round(g2).toString(16)), pad2(Math.round(b10).toString(16))];
  return hex2.join("");
}
...
function _classPrivateFieldInitSpec(e3, t5, a2) {
  _checkPrivateRedeclaration(e3, t5), t5.set(e3, a2);
}
...
function _unsupportedIterableToArray4(r2, a2) {
  if (r2) {
    ...
    var t5 = {}.toString.call(r2).slice(8, -1);
    return "Object" === t5 && r2.constructor && (t5 = r2.constructor.name), "Map" === t5 || "Set" === t5 ? Array.from(r2) : "Arguments" === t5 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t5) ? _arrayLikeToArray4(r2, a2) : void 0;
  }
}
var ENTROPY = 123;
...
function L(n2, l2, u2, t5, i2, r2, o2, e3, f2, c4, a2) {
  var s2, h2, p2, v2, y2, _2, g2, m2 = t5 && t5.__k || w, b10 = l2.length;
  for (f2 = T(u2, l2, m2, f2, b10), s2 = 0; s2 < b10; s2++) null != (p2 = u2.__k[s2]) && (h2 = -1 != p2.__i && m2[p2.__i] || d, p2.__i = s2, _2 = q(n2, p2, h2, i2, r2, o2, e3, f2, c4, a2), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), a2.push(p2.ref, p2.__c || v2, p2)), null == y2 && null != v2 && (y2 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f2 = j(p2, f2, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y2, f2;
}
function T(n2, l2, u2, t5, i2) {
  var r2, o2, e3, f2, c4, a2 = u2.length, s2 = a2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++) null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? ("string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? o2 = n2.__k[r2] = x(null, o2, null, null, null) : g(o2) ? o2 = n2.__k[r2] = x(S, { children: o2 }, null, null, null) : void 0 === o2.constructor && o2.__b > 0 ? o2 = n2.__k[r2] = x(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : n2.__k[r2] = o2, f2 = r2 + h2, o2.__ = n2, o2.__b = n2.__b + 1, e3 = null, -1 != (c4 = o2.__i = O(o2, u2, f2, s2)) && (s2--, (e3 = u2[c4]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c4 && (i2 > a2 ? h2-- : i2 < a2 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c4 != f2 && (c4 == f2 - 1 ? h2-- : c4 == f2 + 1 ? h2++ : (c4 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (s2) for (r2 = 0; r2 < a2; r2++) null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t5 && (t5 = $(e3)), K2(e3, e3));
  return t5;
}
...
function O(n2, l2, u2, t5) {
  var i2, r2, o2, e3 = n2.key, f2 = n2.type, c4 = l2[u2], a2 = null != c4 && 0 == (2 & c4.__u);
  if (null === c4 && null == e3 || a2 && e3 == c4.key && f2 == c4.type) return u2;
  if (t5 > (a2 ? 1 : 0)) {
    for (i2 = u2 - 1, r2 = u2 + 1; i2 >= 0 || r2 < l2.length; ) if (null != (c4 = l2[o2 = i2 >= 0 ? i2-- : r2++]) && 0 == (2 & c4.__u) && e3 == c4.key && f2 == c4.type) return o2;
  }
  return -1;
}
function z(n2, l2, u2) {
...
function q(n2, u2, t5, i2, r2, o2, e3, f2, c4, a2) {
  var s2, h2, p2, v2, y2, d2, _2, k2, x2, M, $2, I2, P2, A3, H2, T2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t5.__u && (c4 = !!(32 & t5.__u), o2 = [f2 = u2.__e = t5.__e]), (s2 = l.__b) && s2(u2);
  n: if ("function" == typeof T2) try {
    if (k2 = u2.props, x2 = T2.prototype && T2.prototype.render, M = (s2 = T2.contextType) && i2[s2.__c], $2 = s2 ? M ? M.props.value : s2.__ : i2, t5.__c ? _2 = (h2 = u2.__c = t5.__c).__ = h2.__E : (x2 ? u2.__c = h2 = new T2(k2, $2) : (u2.__c = h2 = new C2(k2, $2), h2.constructor = T2, h2.render = Q), M && M.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), x2 && null == h2.__s && (h2.__s = h2.state), x2 && null != T2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = m({}, h2.__s)), m(h2.__s, T2.getDerivedStateFromProps(k2, h2.__s))), v2 = h2.props, y2 = h2.state, h2.__v = u2, p2) x2 && null == T2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), x2 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
      if (x2 && null == T2.getDerivedStateFromProps && k2 !== v2 && null != h2.componentWillReceiveProps && h2.componentWillReceiveProps(k2, $2), u2.__v == t5.__v || !h2.__e && null != h2.shouldComponentUpdate && false === h2.shouldComponentUpdate(k2, h2.__s, $2)) {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i2 = m(m({}, i2), h2.getChildContext())), x2 && !p2 && null != h2.getSnapshotBeforeUpdate && (d2 = h2.getSnapshotBeforeUpdate(v2, y2)), A3 = null != s2 && s2.type === S && null == s2.key ? E2(s2.props.children) : s2, f2 = L(n2, g(A3) ? A3 : [A3], u2, t5, i2, r2, o2, e3, f2, c4, a2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e3.push(h2), _2 && (h2.__E = h2.__ = null);
  } catch (n3) {
    if (u2.__v = null, c4 || null != o2) if (n3.then) {
      for (u2.__u |= c4 ? 160 : 128; f2 && 8 == f2.nodeType && f2.nextSibling; ) f2 = f2.nextSibling;
  ...
  else null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = G(t5.__e, u2, t5, i2, r2, o2, e3, c4, a2);
...
function G(u2, t5, i2, r2, o2, e3, f2, c4, a2) {
  var s2, h2, p2, v2, y2, w2, _2, m2 = i2.props || d, k2 = t5.props, x2 = t5.type;
  ...
  if (null == u2) {
    ...
    u2 = document.createElementNS(o2, x2, k2.is && k2), c4 && (l.__m && l.__m(t5, e3), c4 = false), e3 = null;
  }
  if (null == x2) m2 === k2 || c4 && u2.data == k2 || (u2.data = k2);
  else {
    if (e3 = "textarea" == x2 && null != k2.defaultValue ? null : e3 && n.call(u2.childNodes), !c4 && null != e3) for (m2 = {}, s2 = 0; s2 < u2.attributes.length; s2++) m2[(y2 = u2.attributes[s2]).name] = y2.value;
    ...
    for (s2 in k2) y2 = k2[s2], "children" == s2 ? v2 = y2 : "dangerouslySetInnerHTML" == s2 ? h2 = y2 : "value" == s2 ? w2 = y2 : "checked" == s2 ? _2 = y2 : c4 && "function" != typeof y2 || m2[s2] === y2 || N(u2, s2, y2, m2[s2], o2);
    if (h2) c4 || p2 && (h2.__html == p2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t5.__k = [];
    else if (p2 && (u2.innerHTML = ""), L("template" == t5.type ? u2.content : u2, g(v2) ? v2 : [v2], t5, i2, r2, "foreignObject" == x2 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && $(i2, 0), c4, a2), null != e3) for (s2 = e3.length; s2--; ) b(e3[s2]);
    c4 && "textarea" != x2 || (s2 = "value", "progress" == x2 && null == w2 ? u2.removeAttribute("value") : null != w2 && (w2 !== u2[s2] || "progress" == x2 && !w2 || "option" == x2 && w2 != m2[s2]) && N(u2, s2, w2, m2[s2], o2), s2 = "checked", null != _2 && _2 != u2[s2] && N(u2, s2, _2, m2[s2], o2));
  }
  return u2;
}
function J(n2, u2, t5) {
...
function _unsupportedIterableToArray5(r2, a2) {
  if (r2) {
    ...
    var t5 = {}.toString.call(r2).slice(8, -1);
    return "Object" === t5 && r2.constructor && (t5 = r2.constructor.name), "Map" === t5 || "Set" === t5 ? Array.from(r2) : "Arguments" === t5 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t5) ? _arrayLikeToArray5(r2, a2) : void 0;
  }
}
...
var utils = {
  ...
  compute: function(t5, points, _3d) {
    ...
    if (order < 4) {
      let mt2 = mt * mt, t22 = t5 * t5, a2, b10, c4, d2 = 0;
      if (order === 2) {
      ...
      const ret = {
        x: a2 * p2[0].x + b10 * p2[1].x + c4 * p2[2].x + d2 * p2[3].x,
        y: a2 * p2[0].y + b10 * p2[1].y + c4 * p2[2].y + d2 * p2[3].y,
        t: t5
      };
      if (_3d) {
        ret.z = a2 * p2[0].z + b10 * p2[1].z + c4 * p2[2].z + d2 * p2[3].z;
      }
      return ret;
    }
  ...
  derive: function(points, _3d) {
    ...
    for (let p2 = points, d2 = p2.length, c4 = d2 - 1; d2 > 1; d2--, c4--) {
      const list = [];
      for (let j2 = 0, dpt; j2 < c4; j2++) {
        dpt = {
          x: c4 * (p2[j2 + 1].x - p2[j2].x),
          y: c4 * (p2[j2 + 1].y - p2[j2].y)
        };
        if (_3d) {
          dpt.z = c4 * (p2[j2 + 1].z - p2[j2].z);
        }
        list.push(dpt);
      }
      dpoints.push(list);
  ...
  approximately: function(a2, b10, precision) {
    return abs(a2 - b10) <= (precision || epsilon);
  },
  length: function(derivativeFn) {
    const z2 = 0.5, len = utils.Tvalues.length;
    let sum3 = 0;
    for (let i2 = 0, t5; i2 < len; i2++) {
      t5 = z2 * utils.Tvalues[i2] + z2;
  ...
  roots: function(points, line) {
    ...
    if (order === 2) {
      const a3 = aligned[0].y, b11 = aligned[1].y, c5 = aligned[2].y, d3 = a3 - 2 * b11 + c5;
      if (d3 !== 0) {
        const m1 = -sqrt(b11 * b11 - a3 * c5), m2 = -a3 + b11, v12 = -(m1 + m2) / d3, v2 = -(-m1 + m2) / d3;
        return [v12, v2].filter(reduce3);
      } else if (b11 !== c5 && d3 === 0) {
        return [(2 * b11 - c5) / (2 * b11 - 2 * c5)].filter(reduce3);
      }
      return [];
    }
    const pa = aligned[0].y, pb = aligned[1].y, pc = aligned[2].y, pd = aligned[3].y;
    let d2 = -pa + 3 * pb - 3 * pc + pd, a2 = 3 * pa - 6 * pb + 3 * pc, b10 = -3 * pa + 3 * pb, c4 = pa;
    if (utils.approximately(d2, 0)) {
      if (utils.approximately(a2, 0)) {
        if (utils.approximately(b10, 0)) {
          return [];
        }
        return [-c4 / b10].filter(reduce3);
      }
      const q3 = sqrt(b10 * b10 - 4 * a2 * c4), a22 = 2 * a2;
      return [(q3 - b10) / a22, (-b10 - q3) / a22].filter(reduce3);
    }
    a2 /= d2;
    b10 /= d2;
    c4 /= d2;
    const p2 = (3 * b10 - a2 * a2) / 3, p3 = p2 / 3, q2 = (2 * a2 * a2 * a2 - 9 * a2 * b10 + 27 * c4) / 27, q22 = q2 / 2, discriminant = q22 * q22 + p3 * p3 * p3;
    let u1, v1, x1, x2, x3;
    if (discriminant < 0) {
  ...
  droots: function(p2) {
    if (p2.length === 3) {
      const a2 = p2[0], b10 = p2[1], c4 = p2[2], d2 = a2 - 2 * b10 + c4;
      if (d2 !== 0) {
        const m1 = -sqrt(b10 * b10 - a2 * c4), m2 = -a2 + b10, v1 = -(m1 + m2) / d2, v2 = -(-m1 + m2) / d2;
        return [v1, v2];
      } else if (b10 !== c4 && d2 === 0) {
        return [(2 * b10 - c4) / (2 * (b10 - c4))];
      }
      return [];
    }
    if (p2.length === 2) {
      const a2 = p2[0], b10 = p2[1];
      if (a2 !== b10) {
        return [a2 / (a2 - b10)];
      }
      return [];
  ...
  inflections: function(points) {
    ...
    const p2 = utils.align(points, { p1: points[0], p2: points.slice(-1)[0] }), a2 = p2[2].x * p2[1].y, b10 = p2[3].x * p2[1].y, c4 = p2[1].x * p2[2].y, d2 = p2[3].x * p2[2].y, v1 = 18 * (-3 * a2 + 2 * b10 + 3 * c4 - d2), v2 = 18 * (3 * a2 - b10 - 3 * c4), v3 = 18 * (c4 - a2);
  ...
  getccenter: function(p1, p2, p3) {
    ...
    let s2 = atan2(p1.y - arc.y, p1.x - arc.x), m2 = atan2(p2.y - arc.y, p2.x - arc.x), e3 = atan2(p3.y - arc.y, p3.x - arc.x), _2;
    if (s2 < e3) {
      if (s2 > m2 || m2 > e3) {
        s2 += tau2;
      }
...
var PolyBezier = class _PolyBezier {
  ...
  bbox() {
    ...
    var bbox = c4[0].bbox();
    for (var i2 = 1; i2 < c4.length; i2++) {
      utils.expandbox(bbox, c4[i2].bbox());
    }
    return bbox;
  }
  offset(d2) {
...
var Bezier = class _Bezier {
  ...
  on(point2, error) {
    ...
    for (let i2 = 0, c4, t5 = 0; i2 < lut.length; i2++) {
      c4 = lut[i2];
  ...
  offset(t5, d2) {
    if (typeof d2 !== "undefined") {
      const c4 = this.get(t5), n2 = this.normal(t5);
      const ret = {
        c: c4,
        n: n2,
        x: c4.x + n2.x * d2,
...
function _unsupportedIterableToArray6(r2, a2) {
  if (r2) {
    ...
    var t5 = {}.toString.call(r2).slice(8, -1);
    return "Object" === t5 && r2.constructor && (t5 = r2.constructor.name), "Map" === t5 || "Set" === t5 ? Array.from(r2) : "Arguments" === t5 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t5) ? _arrayLikeToArray6(r2, a2) : void 0;
  }
}
var index6 = function() {
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i2 = -1, j2 = 0, n2 = specifier.length, c4, pad4, format2;
      ...
      while (++i2 < n2) {
        if (specifier.charCodeAt(i2) === 37) {
          ...
          if (format2 = formats2[c4]) c4 = format2(date, pad4);
          string.push(c4);
          j2 = i2 + 1;
        }
      }
  ...
  function parseSpecifier(d2, specifier, string, j2) {
    var i2 = 0, n2 = specifier.length, m2 = string.length, c4, parse;
    while (i2 < n2) {
      if (j2 >= m2) return -1;
      c4 = specifier.charCodeAt(i2++);
      if (c4 === 37) {
        c4 = specifier.charAt(i2++);
        parse = parses[c4 in pads ? specifier.charAt(i2++) : c4];
...
function _unsupportedIterableToArray7(r2, a2) {
  if (r2) {
    ...
    var t5 = {}.toString.call(r2).slice(8, -1);
    return "Object" === t5 && r2.constructor && (t5 = r2.constructor.name), "Map" === t5 || "Set" === t5 ? Array.from(r2) : "Arguments" === t5 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t5) ? _arrayLikeToArray7(r2, a2) : void 0;
  }
}
  ...
  init: function init4(domNode, state) {
    ...
    select_default2(state.canvas).call(drag_default().subject(function() {
      ...
      ["x", "y"].forEach(function(c4) {
        return obj["f".concat(c4)] = obj[c4] = initPos[c4] + (dragPos[c4] - initPos[c4]) / k2;
      });
